...
import (
	"github.com/enablecloud/kulbe/client/application/clientset/internalversion/scheme"
...
func (c *ExampleClient) ApplicationTypes(namespace string) ApplicationTypeInterface {

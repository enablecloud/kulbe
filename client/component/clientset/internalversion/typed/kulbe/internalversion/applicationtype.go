...
import (
	...
	scheme "github.com/enablecloud/kulbe/client/component/clientset/internalversion/scheme"
...
type ApplicationTypeInterface interface {
	Create(*component.ApplicationType) (*component.ApplicationType, error)
	Update(*component.ApplicationType) (*component.ApplicationType, error)
	UpdateStatus(*component.ApplicationType) (*component.ApplicationType, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*component.ApplicationType, error)
	List(opts v1.ListOptions) (*component.ApplicationTypeList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *component.ApplicationType, err error)
...
func newApplicationTypes(c *KulbeClient, namespace string) *applicationTypes {
...
func (c *applicationTypes) Get(name string, options v1.GetOptions) (result *component.ApplicationType, err error) {
	result = &component.ApplicationType{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *applicationTypes) List(opts v1.ListOptions) (result *component.ApplicationTypeList, err error) {
	result = &component.ApplicationTypeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("applicationtypes").
...
func (c *applicationTypes) Create(applicationType *component.ApplicationType) (result *component.ApplicationType, err error) {
	result = &component.ApplicationType{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("applicationtypes").
...
func (c *applicationTypes) Update(applicationType *component.ApplicationType) (result *component.ApplicationType, err error) {
	result = &component.ApplicationType{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("applicationtypes").
...
func (c *applicationTypes) UpdateStatus(applicationType *component.ApplicationType) (result *component.ApplicationType, err error) {
	result = &component.ApplicationType{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("applicationtypes").
...
func (c *applicationTypes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *component.ApplicationType, err error) {
	result = &component.ApplicationType{}
